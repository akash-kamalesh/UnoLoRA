...
wandb.init(project="YOUR-WANDB-PROJECT", entity="YOUR-WANDB-ENTITY", name="t5-separate-lora-qqp-seed42", allow_val_change=True)
...
trainer.train()
call()
trainer.save_model("shared_qqp_seed42")

...
wandb.init(project="YOUR-WANDB-PROJECT", entity="YOUR-WANDB-ENTITY", name="t5-separate-lora-qnli-seed42_test", allow_val_change=True)
...
trainer.train()
call()
trainer.save_model("qnli_lora_seed42_test")
